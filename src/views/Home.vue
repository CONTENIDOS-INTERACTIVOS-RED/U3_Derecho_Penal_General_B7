        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad aborda el concepto de punibilidad en Derecho Penal, clave para determinar cuándo una conducta debe ser sancionada. Se analizan los esquemas del delito desde las teorías clásica, neoclásica y finalista, así como la clasificación de las penas, subrogados penales, exclusiones de punibilidad y extinción de la acción penal. El objetivo es brindar herramientas teóricas y prácticas que permitan una aplicación justa de las sanciones, garantizando proporcionalidad, legalidad y respeto por los derechos fundamentales, con enfoque en justicia restaurativa y prevención.
